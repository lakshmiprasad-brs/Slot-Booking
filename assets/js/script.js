      ...
      let slots_list = slots_data.map(e => {
        return (`
          <div class="row justify-content-md-center">
            <div class="col col-6 time-slot text-center m-2"><a href="#" onclick="Calendly.initPopupWidget({url: '${e.scheduling_url}'});return false">${moment(e.start_time).format('hh:mm A')}</a></div>
          </div>
        `)
      }).join('')
